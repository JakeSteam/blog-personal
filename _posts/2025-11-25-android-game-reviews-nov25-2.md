...
I've played a few of [GX Studio's games](https://play.google.com/store/apps/dev?id=695774513565373570) before over the last few years, and like [Kairosoft's games](https://play.google.com/store/apps/dev?id=7710637777904825280), you _kinda_ know what you're in for, just with a different skin each time. This time, it's tower defence.
...
As with [GX Studio's other games](https://play.google.com/store/apps/dev?id=695774513565373570) (e.g. Lone Tower, reviewed [2 years ago](/june-july-android-game-reviews/#3-lone-tower)), you complete a 1-10 minute playthrough of a simple game (in this case tower defence), with upgrades along the way, until you either fail or complete all stages. Either way you'll earn gems for permanent upgrades, with success having the benefit of unlocking harder, more rewarding difficulties.
...
_Note: I emailed the dev a bug report back in August and he fixed it a few days later, but other than that I have no connection / affiliation with the game._
...
- There is a fairly active [Discord server](https://discord.com/invite/gaDqxkTTGp) for all GX Studio games.
...
- You _can_ manually aim your archer by tapping, but it doesn't seem to be very useful.
